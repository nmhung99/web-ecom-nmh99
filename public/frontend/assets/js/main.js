(function ($) {
    ...
    $('.pro-details-size-content').on('click', 'a', function(e){
        ...
        $(this).parent().find('input').addClass('active').parent().siblings().children('input').removeClass('active');
        $('.pro-details-size-content').find('input.active').attr('name','productcolor').parent().siblings().children('input').attr('name','');
        // var data = $('.pro-details-size-content').find('a').hasClass('active');
        // console.log(data);
    });
    /*------- Color active -----*/
    $('.pro-details-color-content').on('click', 'a', function(e){
        e.preventDefault();
        $(this).addClass('active').parent().siblings().children('a').removeClass('active');
        // var data = $('.pro-details-color-content').find('.active').text();
        // console.log(data);
    });
    ...
    $(function() {
        sliderrange.slider({
            ...
            slide: function(event, ui) {
                amountprice.val("VND " + ui.values[0].toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + " - VND " + ui.values[1].toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
                minprice.val(ui.values[0]);
                maxprice.val(ui.values[1]);
            }
        });
        amountprice.val("VND " + sliderrange.slider("values", 0).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") +
            " - VND " + sliderrange.slider("values", 1).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,"));
