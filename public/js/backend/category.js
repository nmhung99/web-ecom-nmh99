function addCategory() {
		axios.post('/admin/store/categories', $('#form_category').serialize())
...
function deleteCategory(id) {
		Swal.fire({
			...
			if (result.value) {
				axios.post('/admin/delete/categories', {id:id}, {
					headers: {
...
function updateCategory(id) {
		axios.post('/admin/categories/update/'+id, $('#form_category').serialize())
		.then(function(response){
			Swal.fire({
				icon: 'success',
				title: 'Thông báo',
